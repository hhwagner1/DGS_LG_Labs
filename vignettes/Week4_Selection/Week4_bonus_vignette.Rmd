...
Let’s examine differentiation for the SNP data using FST. There are a multitude of ways to do this, but we will use the varcomp.glob function from the 'hierfstat' package:
