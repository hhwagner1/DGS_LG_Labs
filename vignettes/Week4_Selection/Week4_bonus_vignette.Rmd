...
This code assumes that you have saved the 'ecogen' object 'WWP' from the Week 4 vignette. Here we load it again. We will also need the seedling-level phenotypic data 'phen' again.

```{r}
load(paste0(here(), "/data/WWP.RData"))
