...
#Snails.ecogen <- eco.fill_ecogen_with_df(Snails.ecogen, "SITE", Snails.site.df$SITE, 
#                                XY = NULL, P = NULL, E = Snails.site.df[,-c(1:11)], 
#                                C = NULL, bind_columns = FALSE)
#row.names(Snails.site.df) <- Snails.site.df$SITE
#Snails.ecopop@E <- Snails.site.df[,-c(1:11)]
#test <- eco.fill_ecogen_with_ecopop(Snails.ecopop, Snails.ecogen, "SITE", 
#                            what = c("all", "XY", "P", "E", "C"), bind_columns = FALSE)
