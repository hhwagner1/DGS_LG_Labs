...
# NOTE FROM HW: Are these used anywhere in this worked example?
#require(sp)
#require(rgdal)
#require(igraph)
#require(ecodist)
...
- Please explain how you get to the values by which you divide or rescale each raster.
- Why is err inverted (1/err), but the other rasters not (eg: ffp/5)?
...
- I've integrated three sections into one section and added this caption (a). Maybe edit it to clarify whether this is length or cost of LCP (see next point)?
- What is the cost distance here? I assume it relates to the last cost path. Is it the cumulative cost of the least cost path? Or the length of the least cost path? 
- What kind of plot did you want to create here? Not sure if the plots below are what you had in mind.
