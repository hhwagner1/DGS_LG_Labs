...
As an alternative, here's the same workflow again, but using a pipe and avoiding the function pull that sometimes created an error:

```{r}
percentage_forest_500_b <- nlcd_sampled %>% 
  dplyr::filter(class == 42, 
                metric == "pland") 
percentage_forest_500_b <-percentage_forest_500_b$value
