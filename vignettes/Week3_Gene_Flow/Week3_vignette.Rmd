...
```
The output of the summaru function shows us the following:
...
Both tests suggest that all loci escept for locus "F" are out of HWE globally (across all 181 individuals). Next, we check for HWE of each locus in each population.
