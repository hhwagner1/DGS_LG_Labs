...
NOTE: LECTURE LISTS THE FOLLOWING:

Population level:
- % Polymorphic loci
- Number of alleles
- Allelic richness
- Observed or expected heterozygosity

Individual level:

- Individual heterozygosity (% hetero loci)
- Standardized heterozygosity (Coltman et al. 1999)
- Internatl relatedness (Amos et al 2001)
- Homozygosity by locus (Aparicio et al. 2006)

Differentiation:

Overall measures?:

- Fst (analogues: Gst, Theta, AMOVA, Linearized Fst (Fst/(1-Fst)), G'st, G''st)
- Rst

Population based:
- Jost's D
- Nei's standard genetic distance (Ds)
- Cavalli-Sforza Chord distance (Dc)
- Nei's chord distance (Da)
- Proportion of shared alleles (Dps)
- Conditiona genetic distance (cGD)

Individual-based:

- Proportion of shared alleles (Dps)
- Rousset's a (ar)
- Relatedness/kinship (Queller and Goodnight, Smouse and Peakalll 1999)
- Bray Curtis dissimilarity (Legendre 1998)
...
This worked example uses microsatellite data. For SNP data, see online tutorial "Calculating Basic Population Genetic Statistics from SNP Data":
...
To brush up on Hardy-Weinberg equilibrium (HWE) and Linkage disequilibrium (LD), check "Genetics Tutorial" on DGS Landscape Genetics course web page.
