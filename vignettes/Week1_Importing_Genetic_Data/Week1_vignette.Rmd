...
c) **Import data into gstudio**: Adapt the code from section 5.b to import the genetic data with 'gstudio'. The loci are in columns 6 - 19. What setting for `type` is appropriate for this data set? Check the help file for `read_population` and, if needed, the full documentation of the `gstudio` package at  http://dyerlab.github.io/gstudio/
